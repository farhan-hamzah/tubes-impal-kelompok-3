...
export default function AdminDashboard() {
  ...
  const menus = [
    { label: 'Daftar Client', path: '/admin/clients', icon: '👥' },
    { label: 'Kelola Paket HPC', path: '/admin/paket', icon: '🖥️' },
    { label: 'Kelola Tarif', path: '/admin/tarif', icon: '💰' },
    { label: 'Manajemen Kontrak', path: '/admin/kontrak', icon: '📋' },
    { label: 'Manajemen Invoice', path: '/admin/invoice', icon: '🧾' },
